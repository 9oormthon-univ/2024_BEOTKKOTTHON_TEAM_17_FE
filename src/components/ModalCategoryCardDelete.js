...
import { deleteCategoryCard } from "../utils/axios";

const ModalCategoryCardDelete = ({ category, user, onClose }) => {
  ...
  const deleteCategoryClick = () => {
    deleteCategoryCard(token, categoryId, memberId);
  };
    ...
    <div>
      ...
      <ModalSpace>
        <ModalWrap>
          ...
          <ModalContent>
            <ModalWarn>!</ModalWarn>
            <ModalTitle>분류함에서 명함을 정말 삭제하시겠어요?</ModalTitle>
            <ModalText>
              삭제를 선택하실 경우,
              <br />
              삭제한 명함은 되돌릴 수 없어요.
            </ModalText>
            <CardDeleteBtn onClick={deleteCategoryClick}>삭제</CardDeleteBtn>
